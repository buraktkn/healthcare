 ...
 <!------ Slider ------------>
   <div class="about-banner">
      <div class="wrap">
		   <div class="cssmenu">
				<ul>
				     <li class="active"><a href="hasta.php"><span>Basvuru</span></a></li>
				   <li><a href="liste.php"><span>Donör Listesi</span></a></li>
		...
		<div class="section group">
				<div class="col span_2_of_3">
				   <div class="contact-form">
				  	<h3>Kayıt Formu</h3>
					    <form method="post" action="hastayeni.php">
					    	<div>
						   ...
						   <!--- 	<span><label>Hasta mısınız? Donör mü?</label></span>
							...
							<div>
						    	<span><label>Nakil beklediğiniz organ nedir?</label></span>	
