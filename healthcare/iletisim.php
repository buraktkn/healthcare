				  ...
				  <div class="contact-form">
				  	<h3>Bize Ulaşın...</h3>
					    <form method="post" action="contact-post.html">
						    ...
						    <div>
						    	<span><label>Bize ulaşma sebebinizi lütfen belirtiniz :</label></span>
						    	<span><textarea name="userMsg"> </textarea></span>
						    </div>
						   <div>
						   		<a href="#" class="btn btn-primary btn1">Gönder</a>
						  </div>
					    </form>
				  </div>
  				</div>
				<div class="col span_1_of_3">
					<div class="contact_info">
      			   ...
      			   <div class="company_address">
				     	<h3>Şirket Bilgilerimiz :</h3>
						    	<p>Kadıköy</p>
						   		<p>Healthcare Sağlık Servisi</p>
						   		<p>Türkiye</p>
				   		<p>Telefon:0(216) 472 45 45</p>
				   		<p>Fax: (000) 000 00 00 0</p>
				 	 	<p>Email: <span>healthcare@email.com</span></p>
				   		<p>Bizi Takip Edin... <span>Facebook</span>, <span>Twitter</span></p>
				   </div>
				 </div>
				   <div class="clear"></div>
			  </div>
